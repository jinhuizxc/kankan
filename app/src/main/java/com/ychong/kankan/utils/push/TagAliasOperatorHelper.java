...
public class TagAliasOperatorHelper {
    ...
    private boolean RetryActionIfNeeded(int errorCode, TagAliasBean tagAliasBean) {
        ...
        if (errorCode == 6002 || errorCode == 6014) {
            ...
            if (tagAliasBean != null) {
                ...
                ToastUtils.showShort(context,logs, true);
                return true;
            }
        }
        return false;
    ...
    private boolean RetrySetMObileNumberActionIfNeeded(int errorCode, String mobileNumber) {
        ...
        if (errorCode == 6002 || errorCode == 6024) {
            ...
            ToastUtils.showShort(context,str, true);
            return true;
        }
        return false;
    ...
    public void onTagOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if (tagAliasBean == null) {
            ToastUtils.showShort(context,"获取缓存记录失败", true);
            return;
        }
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if (jPushMessage.getErrorCode() == 0) {
            ...
            Logger.i(TAG, logs);
            editor.putBoolean(BaseContract.FLAG_OF_JIGUANG_ALIAS, true);
            editor.apply();
//            ExampleUtil.showToast(logs, context);
        } else {
            editor.putBoolean(BaseContract.FLAG_OF_JIGUANG_ALIAS, false);
            editor.apply();
