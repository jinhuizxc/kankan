package com.ychong.kankan.utils.widget.view;
...
public class LoadingProgressBar extends View {
    ...
    private static final int STEP = 5;//移动点的移动速度
    private static final int BIG_STEP = 1;//整体旋转速度
    ...
    private static final int ADDITION_LENGTH = 3;//移动点的大小
