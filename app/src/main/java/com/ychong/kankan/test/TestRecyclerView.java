...
public class TestRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public TestRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRecyclerView =  view.findViewById(R.id.refresh_recycler_view);
        mSwipeRefreshLayout =  view.findViewById(R.id.lemon_refresh_layout);
